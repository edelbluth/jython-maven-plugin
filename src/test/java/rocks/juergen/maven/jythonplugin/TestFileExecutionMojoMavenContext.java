 ...
 */
public class TestFileExecutionMojoMavenContext extends AbstractMojoTest {

    @Test
    public void test() throws Exception {
        final File pom = new File(TestFileExecutionMojoMavenContext.class.getResource("poms/context.script.pom.xml").getFile());
        final FileExecutionMojo mojo = (FileExecutionMojo) rule.lookupMojo("file", pom);
        mojo.execute();
